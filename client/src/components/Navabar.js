...
export default function Navbar() {
  ...
  const subjectsToDisplayInTab = user.subjects.map((subject)=>(
    <li key={subject.subject_name} onClick={()=>navigate(`/subjects/${subject.serial_number}`)}>{subject.subject_name}</li>
  ))
